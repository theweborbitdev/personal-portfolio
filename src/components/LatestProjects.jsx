...
function LatestProjects() {
  ...
  return (
    <section className='mt-20 md:mt-40' id='projects'>
      <h2 className='md:text-center text-4xl font-bold text-gray-950 sm:text-6xl lg:mb-12' data-aos='fade-up'>
        My Latest Projects
      </h2>
      ...
      <div className='flex justify-center mt-10 md:mt-1'>
        {['All', 'Web Development', 'Mobile App Development'].map(category => (
          <button
            key={category}
            className='p-2 border border-b-4 border-black rounded-full lg:mb-12 ml-2 hover:bg-primary hover:text-white'
            ...
            <div className='mt-6 relative'>
              ...
              <div className='flex max-w-full items-center gap-3 pt-9 flex-col sm:flex-row sm:w-mx sm:mx-auto lg:mx-0'>
                <a href={project.gitURL}>
                  <button className='md:block p-4 bg-primary2 font-bold border border-b-4 border-black rounded-full hover:text-text-primary hover:border-primary2'>
                    Code Source
                  </button>
                </a>

                <button className='md:block p-4 bg-primary font-bold border border-b-4 border-black rounded-full text-white'>
